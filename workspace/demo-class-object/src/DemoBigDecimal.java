...
public class DemoBigDecimal {
  ...
  public static void main(String[] args) {
    ...
    if (m == 0.0) {
      ...
      result = bd1.divide(BigDecimal.valueOf(m), 2, RoundingMode.HALF_UP).doubleValue();
      System.out.println("Row53 " + result);
    }

    System.out.println("Row56 " + BigDecimal.valueOf(10/3).setScale(2, RoundingMode.UP).doubleValue());
